...
function process (state, configuration, ptl, keyPressed) {
    ...
    const actions = {
        ...
        waitForStart: function () {
            ...
            const ptlZone = state.controlPTL.getConfiguredPTLZoneDevice();
...
function generateGame (configuration, state) {
    ...
    const ptlsWithLedAndV = configuration.filter(o => o.type !== constantsPTL.ELECTROTEC_NODE_TYPE_DPW1 && o.type !== constantsPTL.ELECTROTEC_NODE_TYPE_LCI2_LCIN1);
